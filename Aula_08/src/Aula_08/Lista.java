...
public class Lista{//declaração da classe
  ...
  //Codigos automaticos para Inserir e Apagar no Inicio Apenas
	...
	/*Teste de adaptação(de static void para somente void antes do main da classe)
	 * 
	 * 
	 * 
	 * 
	...
	public static void AdicionarInicio(Lista L1){//Adição Sequencial
	...
	public static void ApagarInicio(Lista L1) {//Remoção Sequencial
