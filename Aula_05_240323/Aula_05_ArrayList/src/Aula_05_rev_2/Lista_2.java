...
public class Lista_2{//declaração da classe
    ...
    public static void cadastro(){//Cadastro dos Duendes-//Codigo para Vetor
...
public static void listaDuende(){//Listagem-Codigo para Vetor
	...
	public static void Ordenate_Sort() {//em Analise(Versão Final(03/04/2023))-//Codigo para Vetor
		if(Lista[0]==null){//se estiver vazia    
            System.out.println("================Sem=Registros=!!==================");
        }else{//se não estiver vazia
        	//laço de repetição
    ...
    public static void cadastrar_Time(){//Codigo para Vetor
        Locale pt_br = new Locale("pt","Brazil");
        Locale.setDefault(pt_br);
