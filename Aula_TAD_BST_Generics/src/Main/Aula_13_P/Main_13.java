...
public class Main_13 {
    public static void main(String[] args) {
        ...
        do{
            ...
            System.out.println("===02 - Em desenvolvimento===================");//Enunciado
            System.out.println("===03 - Em desenvolvimento===================");//Enunciado
            System.out.println("===04 - Em desenvolvimento===================");//Enunciado
